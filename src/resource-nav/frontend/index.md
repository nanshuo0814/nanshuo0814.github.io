...
```component VPCard
      {
        "logo": "https://valtio.pmnd.rs/favicon.ico",
        "title": "Valtio",
...
```component VPCard
      {
        "logo": "https://zh.mobx.js.org/assets/mobx.png",
        "title": "MobX",
        "desc": "一个小型、快速、可扩展的 React 状态管理解决方案",
...
```component VPCard
 {
        "logo": "https://webapp.didistatic.com/static/webapp/shield/Cube-UI_logo.ico",
        "title": "Cube UI",
...
```component VPCard
{
        "logo": "https://simpleicons.org/icons/jquery.svg",
...
```component VPCard
{
        "logo": "https://postcss.org/assets/favicon-2xqjYSmg.ico",
        "title": "PostCSS",
...
```component VPCard
{
        "logo": "https://mpxjs.cn/favicon.ico",
        "title": "Mpx",
        "desc": "增强型跨端小程序框架",
        "link": "https://mpxjs.cn",
 "background": "rgba(253, 230, 138, 0.15)"     }
...
```component VPCard
{
        "logo": "https://www.eggjs.org/favicon.png",
        "title": "Egg",
        "desc": "为企业级框架和应用而生",
...
```component VPCard
{
        "logo": "https://www.rollupjs.com/img/favicon.png",
        "title": "Rollup",
...
```component VPCard
{
        "logo": "https://www.babeljs.cn/img/favicon.png",
        "title": "Babel",
...
```component VPCard
 {
        "logo": "https://docusaurus.io/zh-CN/img/docusaurus.ico",
        "title": "Docusaurus",
...
```component VPCard
 {
        "logo": "https://hexo.io/icon/apple-touch-icon-57x57.png",
        "title": "Hexo",
...
```component VPCard
{
        "logo": "https://emoji.muan.co/appicon.png",
